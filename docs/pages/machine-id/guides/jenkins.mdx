...
**Single-host deployments:** The simplest Jenkins deployments have the
...
**Multihost deployments:** A slightly more complex, but more secure deployment
...
then `tctl` to create a bot user with the roles you want to assign to Machine
